<template>
	<scroll-view scroll-y class="scroll-view" :scroll-into-view="scrollIntoId" enable-back-to-top="true" @scroll="scroll" @scrolltolower="scrolltolower">
		...
		<view>
			...
			<view class="pd-box rich-box"><u-parse :content="info.content | imgConversion" @preview="preview" /></view>
		...
		<view class="pd-box item-list border-bottom" v-for="(el, i) in commentList" :key="i">
			<view class="flex">
				<view class="" style="width: 15%;"><image :src="el.avatar" mode="widthFix" class="header"></image></view>
